...
<<<<<<< HEAD
window.OA_BUILD_STAMP="e048e977e7edb671";
=======
window.OA_BUILD_STAMP="670d710709405141";
>>>>>>> d1f01aa (compressor add)
window.OA_BUILD_VERSION="V20260806.1247";
(function(){"use strict";
...
const Pads = ({
  ...
  const [sampleNames, setSampleNames] = React.useState(() => Array(window.OA_PAD_MAX).fill(null).map((_, i) => {
    const e = window.OA_DRUM_SAMPLES && window.OA_DRUM_SAMPLES[i];
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      width: '100%',
      maxWidth: `${Math.min(1100, 200 * grid.cols)}px`,
      display: 'grid',
      gridTemplateColumns: `repeat(${grid.cols}, max-content)`,
      gap: '8px',
      justifyContent: 'center'
    }
  }, layout.map(padNum => {
...
window.SeqControls = ({
  ...
  }, window.OA_PAD_LAYOUTS.map(l => /*#__PURE__*/React.createElement(SeqButton, {
    key: l.key,
    label: l.label,
...
window.SeqSong = ({
  ...
  const importFile = file => {
    ...
    reader.onload = async () => {
      ...
      const restored = [parsed.mixer ? 'mixer levels' : null, state.synth ? `${state.synth} synth voice(s)` : null, state.pads ? `the ${state.pads} pad grid` : null, state.reverb ? 'reverb' : null, state.delay ? 'tape delays' : null, state.samples ? `${state.samples} sample(s)` : null].filter(Boolean);
...
const SvgFader = ({
  ...
  return /*#__PURE__*/React.createElement("svg", {
    ...
    fill: "#dcdcdc",
    stroke: "#555"
  }), [-9, -6, 6, 9].map(d => /*#__PURE__*/React.createElement("line", {
    key: d,
    x1: 5,
    y1: thumbH / 2 + d,
    x2: thumbW - 5,
...
const NoteFader = ({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      ...
      minWidth: '54px',
      textAlign: 'right',
      color: inTune ? '#4fc3f7' : '#5a7d8c',
      fontVariantNumeric: 'tabular-nums'
    }
  }, window.midiNoteName ? window.midiNoteName(nearest) : nearest, !inTune ? /*#__PURE__*/React.createElement("span", {
    style: {
      color: '#666',
      fontSize: '9px'
    }
...
window.DrumSynthEditor = ({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    }, " ", spec.unit) : null)), spec.unit === 'Hz' && /*#__PURE__*/React.createElement(NoteFader, {
      spec: spec,
      value: v,
      onChange: hz => set(key, hz),
      audition: audition
    }));
  })));
};
...
/* ---- libControl/Mixer/TapeDelayEditor.jsx ---- */
(function(){
...
const BeatFader = ({
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "beat"), /*#__PURE__*/React.createElement("input", {
    type: "range",
    min: lo,
    max: hi,
    step: 1,
    ...
    style: {
      flex: 1,
      minWidth: '70px',
      accentColor: onGrid ? color : '#5a6472',
      cursor: 'pointer'
    }
  }), /*#__PURE__*/React.createElement("span", {
    style: {
      ...
      minWidth: '62px',
      textAlign: 'right',
      color: onGrid ? color : '#5a6472',
      fontVariantNumeric: 'tabular-nums'
    }
  }, window.oaBeatLabel(nearest), !onGrid ? /*#__PURE__*/React.createElement("span", {
    style: {
      color: '#666',
      fontSize: '9px'
    }
...
window.TapeDelayEditor = ({
  ...
  React.useEffect(() => {
    const onChange = e => {
      if (e.detail && e.detail.unit === u) force();
    };
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    value: "",
    onChange: e => {
      if (e.target.value) window.oaApplyDelayPreset(u, e.target.value);
    },
    style: {
      background: '#222',
      color: meta.color,
    ...
    key: k,
    value: k
  }, window.OA_DELAY_PRESETS[k].label))), /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: '10px',
      color: '#777',
      fontStyle: 'italic'
    }
  }, "heads on a tape loop \u2014 wow, flutter and saturation on every lap")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'grid',
      gridTemplateColumns: '1fr',
      gap: '8px'
    ...
    }, p.fmt(unit[p.key]))), side && /*#__PURE__*/React.createElement(BeatFader, {
      u: u,
      side: side,
      spec: p,
      value: unit[p.key],
      bpm: bpm,
      locked: !!unit['sync' + side],
      color: meta.color
    }));
  })), /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, "Feed the reverbs"), window.OA_REVERB_UNITS.map((rvMeta, r) => /*#__PURE__*/React.createElement("div", {
    key: r,
    style: {
      display: 'flex',
      alignItems: 'center',
  ...
  }, "\u2192 ", rvMeta.name), /*#__PURE__*/React.createElement("input", {
    type: "range",
    min: 0,
    max: 1,
    step: 0.01,
    ...
    style: {
      flex: 1,
      minWidth: '70px',
      accentColor: rvMeta.color,
      cursor: 'pointer'
    }
  }), /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: '10px',
      color: (unit.toRv[r] || 0) > 0.005 ? rvMeta.color : '#777',
      minWidth: '62px',
      textAlign: 'right',
      fontVariantNumeric: 'tabular-nums'
    }
  }, Math.round((unit.toRv[r] || 0) * 100), "%")))), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: '9px',
      color: '#666',
      marginTop: '10px',
  ...
  }, "Intensity past ~100% self-oscillates: the loop feeds itself faster than the tape can shed it, and the repeats build until the saturation holds them."));
};
})();

/* ---- libControl/Mixer/ChorusEditor.jsx ---- */
(function(){
...
window.ChorusEditor = ({
  ...
  }, "DIMENSION MODE"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      gap: '6px',
      justifyContent: 'center',
  ...
  }, window.OA_CHORUS_MODES.map((m, i) => /*#__PURE__*/React.createElement(DimButton, {
    key: i,
    mode: i,
    active: mode === i,
    color: meta.color,
  ...
  }, on ? 'ON' : 'BYPASS'))), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: '9px',
      color: '#666',
      marginTop: '10px',
  ...
  }, "Not a warble \u2014 the sweep is kept far too shallow to hear as pitch. The two sides sweep in opposite directions and the wet copy is inverted across the pair, so it mostly cancels in mono and the ear reads what is left as width. 1 is a gentle shimmer; 4 is as far as the box goes."));
};
})();

/* ---- libControl/Mixer/DriveEditor.jsx ---- */
(function(){
...
const DriveKnob = ({
  ...
  value: toNorm(p, value),
  min: 0,
  max: 1,
  defaultVal: toNorm(p, p.def),
  color: color,
  size: size,
...
}, p.label.toUpperCase()), /*#__PURE__*/React.createElement("div", {
  style: {
    fontSize: '9px',
    color: color,
    fontVariantNumeric: 'tabular-nums'
...
window.DriveEditor = ({
  ...
  const dirty = !!opened.current && (opened.current.mode !== unit.mode || params.some(p => opened.current[p.key] !== unit[p.key]));
  const abort = () => {
    if (!opened.current) return;
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, knobs.map(p => /*#__PURE__*/React.createElement(DriveKnob, {
    key: p.key,
    p: p,
    value: unit[p.key],
    color: color,
  ...
  }, /*#__PURE__*/React.createElement(DriveKnob, {
    p: mixP,
    value: unit.mix,
    color: color,
    size: 52,
    ...
    value: "",
    onChange: e => {
      if (e.target.value) window.oaApplyDrivePreset(idx, e.target.value);
    },
    style: {
      background: '#222',
      color: color,
  ...
  }, "drive squashes the peaks; the harmonics that appear are the sound")), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: '9px',
      color: '#666',
      marginTop: '10px',
...
/* ---- libControl/Mixer/CompressorEditor.jsx ---- */
(function(){
...
const PushButton = ({
  ...
  style: {
    ...
    boxShadow: active ? 'inset 0 3px 5px rgba(0,0,0,0.55)' : '0 2px 0 #1a1209, 0 3px 4px rgba(0,0,0,0.5)',
    transform: active ? 'translateY(2px)' : 'none',
    padding: 0,
    fontSize: '8px',
    fontWeight: '700',
...
window.CompressorEditor = ({
  ...
  React.useEffect(() => {
    ...
    window.OA_COMP_PARAMS.forEach(p => {
      opened.current[p.key] = u[p.key];
    });
  }, [idx]);
  const unit = window.oaCompUnit(idx);
  ...
  React.useEffect(() => {
    ...
    const tick = () => {
      ...
      if (needleRef.current) {
        needleRef.current.setAttribute('transform', `rotate(${(A0 + shown * (A1 - A0)).toFixed(2)} 98 158.24)`);
      }
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      ...
      background: on ? 'radial-gradient(circle at 38% 30%, #fff0c8, #ff9a2e 45%, #c85a05 100%)' : 'radial-gradient(circle at 38% 30%, #6b6357, #3a3128 60%, #241d16 100%)',
      boxShadow: on ? '0 0 12px rgba(255,150,40,0.75), inset 0 1px 2px rgba(255,255,255,0.5)' : 'inset 0 2px 4px rgba(0,0,0,0.6)',
      padding: 0
    }
  }), /*#__PURE__*/React.createElement(Engraved, {
    size: 7,
  ...
  }, "IN"), knobCol('mix', 40)), knobCol('input', 62), knobCol('output', 62), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      flexDirection: 'column',
      alignItems: 'center',
  ...
  }, "OA-76"), /*#__PURE__*/React.createElement(Engraved, {
    size: 7,
    style: {
      letterSpacing: '2px',
      opacity: 0.85
    }
  }, "LIMITING AMPLIFIER"), /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: '7px',
      fontWeight: '700',
      letterSpacing: '1px',
    ...
    value: "",
    onChange: e => {
      if (e.target.value) window.oaApplyCompPreset(idx, e.target.value);
    },
    style: {
      background: '#222',
      color: window.OA_COMP_COLOR,
  ...
  }, ratio.hint)), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: '9px',
      color: '#666',
      marginTop: '10px',
...
const Mixer = () => {
  ...
  React.useEffect(() => {
    ...
    const onOpen = e => {
      if (e.detail && e.detail.idx != null) {
        setDrivePad(null);
        setCompPad(null);
        setSynthPad(e.detail.idx);
      }
    };
  ...
  const FX = React.useMemo(() => [...window.OA_REVERB_UNITS.map((m, i) => ({
    kind: 'rv',
    i,
    key: `rv${i}`,
    name: m.name,
  ...
  const fxMeters = fx => /*#__PURE__*/React.createElement(React.Fragment, null, [0, 1].map(ch => /*#__PURE__*/React.createElement("div", {
    key: ch,
    style: {
      width: '6px',
      borderRadius: '2px',
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      }, /*#__PURE__*/React.createElement("span", null, "COMPRESS"), /*#__PURE__*/React.createElement("i", {
        ref: el => {
          grRefs.current[i] = el;
        },
        style: {
      ...
      return /*#__PURE__*/React.createElement("div", {
        ...
        title: `${track.name || 'Track'} → ${fx.name}`,
        style: {
          fontSize: '7px',
          letterSpacing: '.2px',
          fontVariantNumeric: 'tabular-nums',
  ...
  }, Math.round(clickVol * 100))), window.OA_REVERB_UNITS.map((meta, u) => {
    const fx = FX[u];
    const unit = window.oaReverbUnit(u);
    return /*#__PURE__*/React.createElement("div", {
      key: fx.key,
    ...
    }, meta.name), /*#__PURE__*/React.createElement("select", {
      value: unit.tone,
    ...
    }, fxMeters(fx), /*#__PURE__*/React.createElement(SvgFader, {
      value: unit.ret,
      color: meta.color,
      width: 36,
      height: 140,
    ...
    }, Math.round(unit.ret * 100)), /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: '9px',
        color: 'var(--muted)'
      }
    ...
    const thrown = unit.toRv.map((v, r) => v > 0.005 ? `${window.OA_REVERB_UNITS[r].name.replace('RV ', 'R')} ${Math.round(v * 100)}` : null).filter(Boolean);
    return /*#__PURE__*/React.createElement("div", {
      key: fx.key,
      style: {
        background: 'var(--strip)',
    ...
    }, "TAPE"), /*#__PURE__*/React.createElement("button", {
      onClick: () => {
        setTapeUnit(null);
        setChorusUnit(chOpen ? null : u);
      },
    ...
    }, "CHORUS", chMode ? ` ${chMode}` : ''), /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: '8px',
        color: 'var(--muted)',
        fontVariantNumeric: 'tabular-nums'
      }
    }, Math.round(unit.timeL * 1000), "/", Math.round(unit.timeR * 1000), " ms"), /*#__PURE__*/React.createElement("div", {
      style: {
        display: 'flex',
        gap: '3px',
        alignItems: 'stretch',
      ...
      style: {
        fontSize: '8px',
        color: thrown.length ? '#7fd4d6' : 'var(--muted)',
        textAlign: 'center',
        minHeight: '10px'
      }
  ...
  }), document.body), drivePad != null && window.DriveEditor && ReactDOM.createPortal(/*#__PURE__*/React.createElement(window.DriveEditor, {
    idx: drivePad,
    name: tracks[drivePad] && tracks[drivePad].name || `Track ${drivePad + 1}`,
    onClose: () => setDrivePad(null)
  }), document.body), compPad != null && window.CompressorEditor && ReactDOM.createPortal(/*#__PURE__*/React.createElement(window.CompressorEditor, {
    idx: compPad,
    name: tracks[compPad] && tracks[compPad].name || `Track ${compPad + 1}`,
    onClose: () => setCompPad(null)
  }), document.body), tapeUnit != null && window.TapeDelayEditor && ReactDOM.createPortal(/*#__PURE__*/React.createElement(window.TapeDelayEditor, {
    u: tapeUnit,
    bpm: bpm,
    onClose: () => setTapeUnit(null)
  }), document.body), chorusUnit != null && window.ChorusEditor && ReactDOM.createPortal(/*#__PURE__*/React.createElement(window.ChorusEditor, {
    u: chorusUnit,
    onClose: () => setChorusUnit(null)
  }), document.body));
};
window.Mixer = Mixer;
})();
